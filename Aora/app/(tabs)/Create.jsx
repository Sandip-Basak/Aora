import { View, Text, SafeAreaView, ScrollView, TouchableOpacity, Image, ToastAndroid } from 'react-native'
    ...
    <SafeAreaView className='bg-primary h-full'>
      <ScrollView className='px-4 mt-10'>
        ...
        <View className='mt-7 -space-y-2'>
          ...
          <TouchableOpacity onPress={() => openPicker('image')}>
            {form.thumbnail ? (
              ...
              <View
                className='w-full h-16 bg-black-100 rounded-2xl 
        ...
        <FormField
          title="AI Prompt"
          value={form.prompt}
          placeholder="Enter the prompt you used to create this video"
